...
define('modules/list',['exports', 'aurelia-framework', 'aurelia-auth', '../resources/data/todos'], function (exports, _aureliaFramework, _aureliaAuth, _todos) {
	'use strict';
